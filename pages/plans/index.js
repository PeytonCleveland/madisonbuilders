...
const Plans = ({ housePlans }) => {
  ...
  return (
    <>
      <div className="container w-full pt-36 lg:pt-44 pb-8 lg:pb-12 gap-1 lg:gap-2 flex flex-col">
        <h1 className="text-4xl text-gray-900 font-medium">House Plans</h1>
        <p className="font-sans text-gray-600 font-light text-sm lg:text-base lg:w-[750px]">
      ...
      <div className="w-full bg-gradient-to-br from-gray-800 to-gray-900">
        <div className="container flex flex-col gap-6 pt-6 pb-12">
          <h2 className="text-xl text-white font-medium">
            {housePlans.length} Plans found
          </h2>
          <div className="w-full flex flex-col gap-12 lg:grid lg:grid-cols-3">
            {housePlans.map((plan) => {
              return (
                <div
                  onClick={() => {
      ...
      <div className="w-full bg-gradient-to-br from-indigo-700 to-indigo-800">
        <div className="container pt-8 lg:pt-10 lg:pb-11 pb-9 flex flex-col lg:flex-row gap-4 lg:justify-center lg:items-center">
          <h4 className="text-white lg:text-lg">
            Don&apos;t see the perfect plan? View all 30k+ plans on
            Architectural Designs!
          </h4>
          <Link href="https://architecturaldesigns.com" passHref>
            <a className="text-sm lg:text-base bg-white py-1.5 px-5 text-indigo-900 font-medium rounded-full w-fit flex justify-center items-center gap-1.5">
              View all plans{" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
